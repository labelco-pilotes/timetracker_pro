...
const TimeEntrySummary = ({
  ...
  // On utilise en priorité les entrées filtrées, sinon entries, sinon tableau vide
  const list = filteredEntries ?? entries ?? [];

  // Total d'heures : si totalDuration est fourni, on l'utilise, sinon on le recalcule
